...
ShellRoot {
    ...
    function toggleCava() {
        ...
        cavaToggleProc.command = [
            "sh",
            "-c",
            "/home/streak/.config/quickshell-kde/scripts/cava-toggle.sh " + (shell.cavaEnabled ? "on" : "off")
        ]
    ...
    Process {
        id: cavaStatusProc
        command: ["sh", "-c", "/home/streak/.config/quickshell-kde/scripts/cava-toggle.sh status"]
        running: true
    ...
    Process {
        ...
        command: [
            "sh",
            "-c",
            "cat /home/streak/.config/quickshell-kde-profiles/active-profile 2>/dev/null || echo unknown"
        ]
        running: true
    ...
    Process {
        id: barHiddenProc
        command: ["sh", "-c", "/home/streak/.config/quickshell-kde/scripts/bar-hide-state.sh"]
        running: true
