...
ShellRoot {
    ...
    property bool powerPopupOpen || profileSwitcherOpen: false
    ...
    property string profileSwitcherMonitor: ""
        ...
        stdout: SplitParser {
            onRead: data => {
                ...
                if (current.length > 0 && current !== shell.lastProfileSwitcherTrigger) {
                    let parts = current.split("\t")
                    shell.closeAllPopups()
                    shell.profileSwitcherMonitor = parts[1] || ""
    ...
    Variants {
        ...
        PanelWindow {
            ...
            PopupWindow {
                ...
                visible: shell.profileSwitcherOpen && (shell.profileSwitcherMonitor === "" || shell.profileSwitcherMonitor === panel.screenName)
                width: 780
                height: 520
                color: "transparent"
                grabFocus: true
                ...
                Item {
                    ...
                    scale: profileSwitcherPopupWindow.visible ? 1 : 0.94
                    transformOrigin: Item.Center
