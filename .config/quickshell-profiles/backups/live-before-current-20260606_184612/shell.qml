...
ShellRoot {
    ...
    property bool profileSwitcherOpen: false
    property bool barHidden: false
    property string barHiddenMonitor: ""
    property string barHiddenMonitors: ""
    property bool anyPopupOpen: mediaPopupOpen || networkPopupOpen || audioPopupOpen || systemPopupOpen || calendarPopupOpen || powerPopupOpen || profileSwitcherOpen

    property string popupMonitor: ""
    property string launcherMonitor: ""
    property string launcherMode: "apps"
    property string lastLauncherTrigger: ""
    property string lastProfileSwitcherTrigger: ""
    ...
    function closeAllPopups() {
        ...
        shell.profileSwitcherOpen = false
        shell.popupMonitor = ""
    ...
    Process {
        id: profileSwitcherTriggerProc
        command: [
            "sh",
            "-c",
            "cat /tmp/quickshell-profile-menu-trigger 2>/dev/null || true"
        ]
        running: true
        ...
        stdout: SplitParser {
            onRead: data => {
                ...
                if (current.length > 0 && current !== shell.lastProfileSwitcherTrigger) {
                    shell.closeAllPopups()
                    shell.popupMonitor = Quickshell.screens[0].name
                    shell.profileSwitcherOpen = true
                    shell.lastProfileSwitcherTrigger = current
    ...
    Timer {
        ...
        running: true
        repeat: true
        onTriggered: profileSwitcherTriggerProc.running = true
    }
        ...
        PanelWindow {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    color: Qt.rgba(Theme.Colors.barBg.r, Theme.Colors.barBg.g, Theme.Colors.barBg.b, Theme.Colors.barOpacity)
                    opacity: 1.0
                    border.color: Qt.rgba(Theme.Colors.accent.r, Theme.Colors.accent.g, Theme.Colors.accent.b, 0.55)
                    border.width: 1
                    clip: true
            ...
            PopupWindow {
                id: profileSwitcherPopupWindow
                visible: shell.profileSwitcherOpen && shell.popupMonitor === panel.screenName
                width: 430
                height: 240
                color: "transparent"
                grabFocus: true
                ...
                Item {
                    anchors.fill: parent
                    opacity: profileSwitcherPopupWindow.visible ? 1 : 0
                    scale: profileSwitcherPopupWindow.visible ? 1 : 0.90
