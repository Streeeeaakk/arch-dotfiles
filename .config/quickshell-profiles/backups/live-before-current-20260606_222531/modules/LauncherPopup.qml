...
Rectangle {
    ...
    function activateCurrent() {
        ...
        let idx = listView.demeter-2.0Index
                        ...
                        TextInput {
                            ...
                            Keys.onPressed: function(event) {
                                if (event.key === Qt.Key_Escape) {
                                    ...
                                    listView.demeter-2.0Index = Math.min(listView.demeter-2.0Index + 1, root.filteredItems.length - 1)
                                    event.accepted = true
                                } else if (event.key === Qt.Key_Up) {
                                    listView.demeter-2.0Index = Math.max(listView.demeter-2.0Index - 1, 0)
                                    event.accepted = true
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        MouseArea {
                            ...
                            onEntered: listView.demeter-2.0Index = index

                            onClicked: {
                                listView.demeter-2.0Index = index
                                root.activateCurrent()
                            }
                        }
                    }
